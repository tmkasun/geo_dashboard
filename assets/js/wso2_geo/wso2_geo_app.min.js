...
toggled=!0);getAlertsHistory(a);b.drawPath();setTimeout(function(){createChart();chart.load({columns:[b.speedHistory]})},100)}function clearFocus(){selectedSpatialObject&&(spatialObject=currentSpatialObjects[selectedSpatialObject],spatialObject.removePath(),spatialObject.marker.closePopup(),selectedSpatialObject=null)};
